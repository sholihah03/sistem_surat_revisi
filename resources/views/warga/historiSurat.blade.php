      ...
      <div class="mt-8 bg-white p-4 rounded shadow">
        ...
        <ul class="space-y-4">
          <li class="border p-4 rounded-md flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
            <div>
              <h3 class="font-semibold text-gray-800">12345 - Surat Keterangan Domisili</h3>
              <p class="text-sm text-gray-600">Tanggal Pengajuan: 2025-05-10</p>
              <p class="text-sm text-gray-600">Selesai pada 2025-05-15</p>
            </div>
            <a href="#" target="_blank" class="text-blue-600 hover:underline">Download Surat</a>
          </li>
          <li class="border p-4 rounded-md flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
            <div>
              <h3 class="font-semibold text-gray-800">Surat Keterangan Tidak Mampu</h3>
              <p class="text-sm text-gray-600">Tanggal Pengajuan: 2025-05-08</p>
              <p class="text-sm text-gray-600">Selesai pada 2025-05-14</p>
            </div>
            <a href="#" target="_blank" class="text-blue-600 hover:underline">Download Surat</a>
          </li>
        </ul>
