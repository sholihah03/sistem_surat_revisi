            ...
            <form x-ref="form" method="POST" action="{{ route('formPengajuanSuratStore') }}">
                ...
                <div class="pl-6">
                    ...
                    <div class="flex">
                        ...
                        <p class="mb-2">
                            : <input type="text" name="tempat_lahir" required class="border border-gray-300 px-2 py-1 rounded w-36 inline-block" />
                            <input type="date" name="tanggal_lahir" required class="border border-gray-300 px-2 py-1 rounded w-40 inline-block ml-2" />
                        </p>
                    </div>
                    <div class="flex">
                    ...
                    <div class="flex items-center">
                        ...
                        <p>
                            : <select name="status_perkawinan" required class="border border-gray-300 px-3 py-1 rounded w-[19rem] mb-2 max-w-sm">
                    ...
                    <div class="flex items-center">
                        ...
                        <p>
                            : <input type="text" name="agama" required class="border border-gray-300 px-3 py-1 rounded w-[19rem] mb-2 max-w-sm" />
                        </p>
                    </div>
                    <div class="flex items-center">
                        <p class="w-52">Pekerjaan</p>
                        <p>
                            : <input type="text" name="pekerjaan" required class="border border-gray-300 px-3 py-1 rounded w-[19rem] mb-2 max-w-sm" />
                        </p>
                    </div>
                    <div class="flex">
