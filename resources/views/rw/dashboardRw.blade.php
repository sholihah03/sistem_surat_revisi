...
<body class="min-h-screen bg-gradient-to-br from-green-100 via-white to-yellow-100 font-inter">
    ...
    <header class="fixed top-0 left-0 right-0 bg-white shadow-md p-4 flex justify-between items-center z-50">
        ...
        <div class="flex items-center gap-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700 hover:text-green-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Profile Icon -->
            <button class="rounded-full overflow-hidden w-8 h-8 bg-green-100 hover:ring-2 hover:ring-green-400">
